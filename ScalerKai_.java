...
public class ScalerKai_ implements PlugIn, TextListener, FocusListener {
	...
	public void setXYZScaling(double x, double y, double z, int depth) {
	...
	public void setIMP(ImagePlus inputIMP) {
		imp = inputIMP;
	}
	...
	boolean showDialog(ImageProcessor ip) {
		...
		if (isStack)
			//newDepth = 162;//(int)Tools.parseDouble(gd.getNextString(), 0);
